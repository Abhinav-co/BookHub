...
import kotlinx.android.synthetic.main.recyclar_favourites_row.view.*

class AdapterFavourites(val context: Context,val bookList: List<BookEntity>):RecyclerView.Adapter<AdapterFavourites.FavouriteViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavouriteViewHolder {
        val view=LayoutInflater.from(parent.context)
            .inflate(R.layout.recyclar_favourites_row,parent,false)
